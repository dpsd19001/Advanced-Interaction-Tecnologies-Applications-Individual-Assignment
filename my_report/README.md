...
Αρχικά, είναι λίγο πιο εύκολο στην αρχή να χρησιμοποιήσεις τον προσομοιωτή για να έχεις την δυνατότητα να είναι περισσότερο ελέγξιμος. Οπότε, καλύτερα είναι να χρησιμοποιήσεις στο τέλος του προγράμματος την κάμερα για την πρωτοτυποποίηση και την δοκιμή των ανθρώπων τρέχωντάς το.
