...
ΠΛΕΟΝΕΚΤΗΜΑΤΑ
1. Δεν χρειάζεται να έχεις ποντίκι
2. Χρειάζεσαι μόνο κάμερα
3. Μπορείς να το χρησιμοποιήσεις και αποπιο μακριά συγκριτικά με το ποντίκι.

ΜΕΙΟΝΕΚΤΗΜΑΤΑ
1. Μπορεί να κολλήσει μερικές φορές χωρίς να έχει ροή
2. Απαραίτητη η κατοχή κάμερας
